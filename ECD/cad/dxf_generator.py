...
try:
    from ECD.electrical.wire_router import subtract_intervals, route_wire_bend, build_daisy_chain_routes, calculate_canonical_wire_graph
except ImportError:
    from electrical.wire_router import subtract_intervals, route_wire_bend, build_daisy_chain_routes, calculate_canonical_wire_graph
...
# Routing functions imported from ECD.electrical.wire_router at top level
...
try:
    ...
    from ECD.cad.layout_sections import get_group_entities, get_group_graphics_and_text, get_per_symbol_graphics_and_text, render_entities_to_svg
except ImportError:
    from renderers import render_doc_to_svg, render_doc_to_png, render_doc_to_pdf
    from layout_sections import get_group_entities, get_group_graphics_and_text, get_per_symbol_graphics_and_text, render_entities_to_svg